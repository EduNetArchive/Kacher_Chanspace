...
def main(args):
    ...
    # QDataset(self, frames, qcharge_path=None, topology=None, atoms='protein and not name H*', 
            # skip=1, start=0, stop=-1, meanval=0, stdval=1, in_memory=False, 
            # transform=False, plane='xy', root='/home/ebam/kacher1/molearn/DATA', exp_name='new_exp'):
    ...
    if args.extra:
        model.load_state_dict(torch.load(args.extra),strict=False)
